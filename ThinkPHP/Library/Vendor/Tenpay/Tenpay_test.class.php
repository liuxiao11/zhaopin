...
//			$this->notify_url=$notify_url?$notify_url:rtrim(HOST,'/').'/mobile2/pay/tenpay_notify';
            ...
            $this->appid = 'wx73cbde76543fb106';  //微信开放平台  appid
            $this->appsecret = 'ce4f3c51eae7dd3e29699f9cdf032bef'; //微信开放平台  appsecret
            $this->mchid = '1435150602';  //微信商户平台 id
            $this->key = '686122d8e48c0fbec5571946a459asdf'; //微信商户平台  api秘钥  md5('swift')
            $this->notify_url=$notify_url?$notify_url:rtrim(HOST,'/').'/mobile2/pay/tenpay_notify';
