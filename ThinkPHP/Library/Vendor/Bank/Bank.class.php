...
class Bank{
		...
		public function __construct($card_number) {
			...
			$bank=$this->info($card_number);
			$bankinfo=explode('-', $bank);
			$this->bankname=$bankinfo[0];
			$this->name=$bankinfo[1];
			$this->type=$bankinfo[2];
		}
		
		/**
		 * 所有银行名称及属性		
		 */
		private function info($card){
