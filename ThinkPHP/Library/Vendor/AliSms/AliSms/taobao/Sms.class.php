<?php
namespace Vendor\AliSms\Taobao;
/* *
* 类名：阿里大鱼短信平台
* 功能：给手机发送短信信息
* 详细：验证码等
...
use Vendor\AliSms\Taobao\Top\TopClient;
use Vendor\AliSms\Taobao\Top\Request\AlibabaAliqinFcSmsNumSendRequest;
...
require 'top/request/AlibabaAliqinFcSmsNumSendRequest.class.php';

//require 'top/request/AlibabaAliqinFcTtsNumSinglecallRequest.php';
//require 'top/request/AlibabaAliqinFcVoiceNumDoublecallRequest.php';
//require 'top/request/AlibabaAliqinFcVoiceNumSinglecallRequest.php';
class Sms{
	...
	public function send($tel, $sign, $template,$param='',  $userId=0){
		...
		$c = new TopClient;
		$c->appkey = '23325191';
		$c->secretKey = '94483b52f96ddd46179af5863d8d8229';
