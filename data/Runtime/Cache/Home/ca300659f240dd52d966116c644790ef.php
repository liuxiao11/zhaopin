        ...
        <div class="detail-cont">
            <div class="top-box">
                ...
                <div class="contact-style">
                    ...
                    <div class="p">
                        <span class="addr"><img src="/Public/images/l_icon_03.png" alt=""/>证书所在地：<?php echo ($resume_info["cert_province"]); ?>-<?php echo ($resume_info["cert_city"]); ?> </span>
                        <b>&nbsp;&nbsp;|</b>
                        <span>浏览：458</span>
                    </div>
            ...
            <div class="content clearfloat">
                <div class="detail-left lf">
                    ...
                    <ul class="basic-information clearfloat">
                        <li>分类：<span><?php echo ($cat_one[$resume_info['cat_one']]); ?>-<?php echo ($cat_two[$resume_info['cat_one']][$resume_info['cat_two']]); ?></span></li>
                        <li>职称：<span><?php echo ($job_title[$resume_info['job_title']]); ?></span></li>
                    </ul>
                    <div class="introduce">
                        <h3><img src="/Public/images/l_icon_16.png" alt=""/>其他说明</h3>
                        <p>
                            <?php echo ($resume_info["intro"]); ?>
                        </p>
                    </div>
