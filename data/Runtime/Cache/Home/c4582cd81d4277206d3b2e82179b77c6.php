                ...
                <div class="new-information">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/headhunt/edit_resume_part/id/<?php echo ($v["id"]); ?>">编辑</a>
                                <a href="javascript:void(0);" class="del_part" resume_id="<?php echo ($v["id"]); ?>">删除</a>
                            </td>
                        </tr>
                        <?php } ?>
                        </tbody>
...
<script>
    $('.del_part').click(function(){
        ...
        window.location.href = '/headhunt/del_resume_part/resume_id/'+resume_id;
    })
</script>
</body>
</html>