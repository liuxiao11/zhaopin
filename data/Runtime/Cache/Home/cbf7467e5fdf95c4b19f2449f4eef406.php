                ...
                <div class="new-information">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><?php echo ($v["cert_province"]); ?>-<?php echo ($v["cert_city"]); ?></td>
                            <td><?php echo ($status[$v['status']]); ?></td>
                            <td>
                                <a href="/person/edit_resume_part/id/<?php echo ($v["id"]); ?>.html">编辑</a>
                                <a resume_id="<?php echo ($v["id"]); ?>" class="del_part" href="javascript:void(0);">删除</a>
                            </td>
                        </tr>
                        <?php } ?>
                        </tbody>
...
<script>
    $('.del_part').click(function(){
        ...
        window.location.href = '/person/del_part/resume_id/'+resume_id;
    })
</script>
</body>
</html>