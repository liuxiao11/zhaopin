                ...
                <div class="new-information">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><?php echo ($v["company_province"]); ?>-<?php echo ($v["company_city"]); ?></td>
                            <td><?php echo ($cat_one[$v['cat_one']]); ?>-<?php echo ($cat_two[$v['cat_one']][$v['cat_two']]); ?></td>
                            <td><?php echo ($status[$v['status']]); ?></td>
                            <td>
                                <a href="/headhunt/edit_invite_part/id/<?php echo ($v["id"]); ?>">编辑</a>
                                <a href="javascript:void(0);" class="del_part" invite_id="<?php echo ($v["id"]); ?>">删除</a>
                            </td>
                        </tr>
                        <?php } ?>
                        </tbody>
...
<script>
    $('.del_part').click(function(){
        ...
        window.location.href = '/headhunt/del_invite_part/invite_id/'+invite_id;
    })
</script>
</body>
</html>