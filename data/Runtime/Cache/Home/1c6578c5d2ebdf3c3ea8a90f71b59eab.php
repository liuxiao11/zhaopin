    ...
    <div class="job-box">
        <div class="container">
            ...
            <div style="color: #999999">
                <span class="addr"><img src="/Public/images/l_icon_03.png" alt=""/>兼职地区：<?php echo ($invite_info["company_province"]); ?>-<?php echo ($invite_info["company_city"]); ?></span>
                <b>|</b>
                <span>浏览：458</span>
                <b>|</b>
            ...
            <div class="content clearfloat">
                <div class="detail-left lf" style="padding-top: 0">
                    ...
                    <ul class="basic-information clearfloat">
                        <li>分类：<span><?php echo ($cat_one[$invite_info['cat_one']]); ?>-<?php echo ($cat_two[$invite_info['cat_one']][$invite_info['cat_two']]); ?></span></li>
                        <li>薪资：<span><?php echo ($salary[$invite_info['salary']]); ?></span></li>
                    </ul>
                    <div class="introduce">
