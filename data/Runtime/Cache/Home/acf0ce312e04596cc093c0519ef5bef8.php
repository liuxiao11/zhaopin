        ...
        <div class="content-rt">
            ...
            <div class="form-box">
                <form action="" method="post">
                    <input type="hidden" name="id" value="<?php echo ($person_info["id"]); ?>"/>
                    <div class="form-group clearfloat">
                        <div class="col-lf lf">
                            <label>姓名</label>
                        </div>
                        <div class="col-rt lf">
                            <input type="text" name="name" value="<?php echo ($person_info["name"]); ?>" placeholder="请输入姓名"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group clearfloat">
                        ...
                        <div class="col-rt lf">
                            <input type="text" name="id_card" value="<?php echo ($person_info["id_card"]); ?>" placeholder="请输入姓名"/>
                        </div>
                    </div>
                        ...
                        <div class="col-rt lf">
                            <div id="city">
                                <select class="prov" name="province" style="width:auto;">
                                    ...
                                    <option value="<?php echo ($v["id"]); ?>" <?php if($person_info['province'] == $v['id']){echo 'selected';} ?>><?php echo ($v["name"]); ?></option>
                                    <?php } ?>
                                </select>&nbsp;
                    ...
                    <div class="form-group clearfloat">
                        ...
                        <div class="col-rt lf">
                            <textarea name="intro"><?php echo ($person_info["intro"]); ?></textarea>
                        </div>
                    </div>
