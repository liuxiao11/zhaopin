        ...
        <div class="content-rt">
            ...
            <div class="form-box">
                <form action="" method="post">
                    <div class="radio-box">
                        <a href="/publish/invite_part_type.html" class="job">兼职招聘</a>
                        <a href="/company/invite_full.html" class="job active">全职招聘</a>
                    </div>
                    <div class="form-group clearfloat">
                        ...
                        <div class="col-rt lf">
                            <input type="text" name="work_name" id="job_name" placeholder="工作名称"/>
                        </div>
                    </div>
                    <div class="form-group clearfloat">
                        <div class="col-lf lf">
