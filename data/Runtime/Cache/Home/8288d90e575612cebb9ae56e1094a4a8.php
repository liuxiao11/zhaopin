            ...
            <div class="form-box">
                <form action="" method="post">
                    ...
                    <div class="form-group clearfloat">
                        ...
                        <div class="col-rt lf">
                            <input type="text" name="work_name" id="job_name" value="<?php echo ($invite_info["work_name"]); ?>"/>
                        </div>
                    </div>
                    <div class="form-group clearfloat">
                        <div class="col-lf lf">
                        ...
                        <div class="col-rt lf">
                            <div class="selector s">
                                <select name="cat" style="width: 200px;">
                                    ...
                                    <option value="<?php echo ($k); ?>" <?php if($k==$invite_info['cat']){echo 'selected';} ?>><?php echo ($v); ?></option>
                                    <?php } ?>
                                </select>
                    ...
                    <div class="form-group clearfloat">
                        ...
                        <div class="col-rt lf">
                            <div class="selector s">
                                <select name="work_years" style="width: 200px;">
                                    <?php foreach($work_years as $k=>$v){ ?>
                                    <option value="<?php echo ($k); ?>" <?php if($k==$invite_info['work_years']){echo 'selected';} ?>><?php echo ($v); ?></option>
                                    <?php } ?>
                                </select>
                                <i><img src="/Public/images/down.jpg" alt=""/></i>
                            </div>
                        ...
                        <div class="col-rt lf ">
                            <div id="city">
                                <select class="prov" name="work_province" style="width:auto;">
                                    ...
                                    <option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $invite_info['work_province']){echo 'selected';} ?>><?php echo ($v["name"]); ?></option>
                                    <?php } ?>
                                </select>&nbsp;
                                <select class="city" name="work_city" style="width:auto;">
                                    <option value="0">请选择</option>
                                    <?php foreach($city_list as $k=>$v){ ?>
                                    <option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $invite_info['work_city']){echo 'selected';} ?>><?php echo ($v["name"]); ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-rt lf">
                            <div class="selector s">
                                <select name="education" style="width: 200px;">
                                    ...
                                    <option value="<?php echo ($k); ?>" <?php if($k==$invite_info['education']){echo 'selected';} ?>><?php echo ($v); ?></option>
                                    <?php } ?>
                                </select>
                                <i><img src="/Public/images/down.jpg" alt=""/></i>
                            </div>
                    ...
                    <div class="form-group clearfloat">
                        ...
                        <div class="col-rt lf l">
                            <input type="text" name="phone" id="c_tel" value="<?php echo ($invite_info["phone"]); ?>" />
                        </div>
                    </div>
                    <div class="form-group clearfloat">
