                ...
                <div class="new-information">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/person/edit_resume_full/id/<?php echo ($v["id"]); ?>">编辑</a>
                                <a resume_id="<?php echo ($v["id"]); ?>" class="del_full" href="javascript:void(0);">删除</a>
                            </td>
                        </tr>
                        <?php } ?>
                        </tbody>
...
<script>
    $('.del_full').click(function(){
        ...
        window.location.href = '/person/del_full/resume_id/'+resume_id;
    })
</script>
</body>
</html>