            ...
            <div class="form-box">
                <form action="" method="post">
                    ...
                    <div class="form-group clearfloat">
                        ...
                        <div class="col-rt lf">
                            <input type="text" name="name" id="job_name" value="<?php echo ($resume_info["name"]); ?>"/>
                        </div>
                    </div>
                    <div class="form-group clearfloat">
                        <div class="col-lf lf">
                        ...
                        <div class="col-rt lf">
                            <div class="selector s">
                                <select name="cat" style="width: 200px;">
                                    ...
                                    <option value="<?php echo ($k); ?>" <?php if($k == $resume_info['cat']){echo 'selected';} ?>><?php echo ($v); ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="col-rt lf">
                            <div id="city">
                                <select class="prov" name="work_province" style="width:auto;">
                                    ...
                                    <option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $resume_info['work_province']){echo 'selected';} ?>><?php echo ($v["name"]); ?></option>
                                    <?php } ?>
                                </select>&nbsp;
                                <select class="city" name="work_city" style="width:auto;">
                                    <option value="0">请选择</option>
                                    <?php foreach($city_list as $k=>$v){ ?>
                                    <option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $resume_info['work_city']){echo 'selected';} ?>><?php echo ($v["name"]); ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group clearfloat">
                        ...
                        <div class="col-rt lf l">
                            <input type="text" name="salary" value="<?php echo ($resume_info["salary"]); ?>" />
                        </div>
                    </div>
                    <div class="form-group clearfloat">
                        <div class="col-lf lf">
                    ...
                    <div class="form-group clearfloat">
                        ...
                        <div class="col-rt lf l">
                            <input type="text" name="phone" id="c_tel" value="<?php echo ($resume_info["phone"]); ?>"/>
                        </div>
                    </div>
                    <div class="form-group clearfloat">
