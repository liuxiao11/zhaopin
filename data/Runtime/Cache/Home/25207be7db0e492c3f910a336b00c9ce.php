                ...
                <div class="new-information">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/headhunt/edit_invite_full/id/<?php echo ($v["id"]); ?>">编辑</a>
                                <a href="javascript:void(0);" class="del_full" invite_id="<?php echo ($v["id"]); ?>">删除</a>
                            </td>
                        </tr>
                        <?php } ?>
                        </tbody>
...
<script>
    $('.del_full').click(function(){
        ...
        window.location.href = '/headhunt/del_invite_full/invite_id/'+invite_id;
    })
</script>
</body>
</html>