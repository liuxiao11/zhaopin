...
<div class="main-box">
    <div class="container">
        ...
        <div class="nav recruit-nav">
            <a href="/invite/part.html" class="active">兼职招聘</a>
            <a href="/invite/full.html">全职招聘</a>
        ...
        <div class="section">
            <div class="selection">
                ...
                <div class="select-type clearfloat params_list" params="company_province" active="<?php echo ($get['company_province']); ?>">
                    <div class="title lf">省份</div>
                    <div class="select-cont lf">
                        <a href="javascript:void(0);" class="filter <?php if(!$get['company_province']){echo 'active';} ?>" data_data="0">不限</a>
                        <?php foreach($province_list as $k=>$v){ ?>
                        <a href="javascript:void(0);" class="filter <?php if($get['company_province'] == $v['id']){echo 'active';} ?>" data_data="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></a>
                        <?php } ?>
                    </div>
                </div>

                <?php if($get['company_province'] && $city_list){ ?>
                <div class="select-type clearfloat params_list" params="company_city" active="<?php echo ($get['company_city']); ?>">
                    <div class="title lf">城市</div>
                    <div class="select-cont lf">
                        <a href="javascript:void(0);" class="filter <?php if(!$get['company_city']){echo 'active';} ?>" data_data="0">不限</a>
                        <?php foreach($city_list as $k=>$v){ ?>
                        <a href="javascript:void(0);" class="filter <?php if($get['company_city'] == $v['id']){echo 'active';} ?>" data_data="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></a>
                        <?php } ?>
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="c_left lf">
                    <div class="detail-cont recruit_list">
                        <ul class="jobs-cont clearfloat">
                            ...
                            <li>
                                <a href="/invite/look_part/id/<?php echo ($v["id"]); ?>" class="clearfloat">
                                    <div class="lf">
                                        <div class="tit"><?php echo ($v["company_name"]); ?></div>
                                        <div class="job">
                                            <?php echo ($cat_one[$v['cat_one']]); ?>-<?php echo ($cat_two[$v['cat_one']][$v['cat_two']]); ?>
                                        </div>
                                    </div>
                                    <div class="lf">
                                        <div class="tit"></div>
                                        <div class="addr"><?php echo ($v["company_province"]); ?>-<?php echo ($v["company_city"]); ?></div>
                                    </div>
