...
<div class="center-contain">
    ...
    <ul class="parent-list">
        ...
        <li>
            ...
            <ul class="list">
                <li><a href="/home/person/resume_part_list" class="<?php if(ACTION_NAME == 'resume_part_list' || ACTION_NAME == 'edit_resume_part'){echo 'active';} ?>">简历信息<em></em></a></li>
        ...
        <li>
            ...
            <ul class="list">
                <li><a href="/home/person/resume_full_list"class="<?php if(ACTION_NAME == 'resume_full_list' || ACTION_NAME == 'edit_resume_full'){echo 'active';} ?>">简历信息<em></em></a></li>
                <li><a href="">投递记录<em></em></a></li>
            </ul>
        </li>
            ...
            <div class="form-box">
                <form action="" method="post">
                    <div class="form-group clearfloat">
                        ...
                        <div class="col-rt lf">
                            <input type="text" name="title" value="<?php echo ($resume_info["title"]); ?>"/>
                        </div>
                    </div>
                    <div class="form-group clearfloat">
                        <div class="col-lf lf">
                        ...
                        <div class="col-rt lf">
                            <input type="text" name="name" value="<?php echo ($resume_info["name"]); ?>"/>
                        </div>
                    </div>
                        ...
                        <div class="col-rt lf">
                            <div id="city">
                                <select class="prov" name="cert_province" style="width:auto;">
                                    ...
                                    <option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $resume_info['cert_province']){echo 'selected';} ?>><?php echo ($v["name"]); ?></option>
                                    <?php } ?>
                                </select>&nbsp;
                                <select class="city" name="cert_city" style="width:auto;">
                                    <option value="0">请选择</option>
                                    <?php foreach($city_list as $k=>$v){ ?>
                                    <option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $resume_info['cert_city']){echo 'selected';} ?>><?php echo ($v["name"]); ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group clearfloat">
                        ...
                        <div class="col-rt lf">
                            <input type="text" id="price1" name="salary" value="<?php echo ($resume_info["salary"]); ?>"/>元/年
                        </div>
                    </div>
                    <div class="form-group clearfloat">
                        <div class="col-lf lf">
                        ...
                        <div class="col-rt lf">
                            <div class="selector s">
                                <select name="job_title" id="" style="width: 100px;">
                                    ...
                                    <option value="<?php echo ($k); ?>" <?php if($k==$resume_info['job_title']){echo 'selected';} ?>><?php echo ($v); ?></option>
                                    <?php } ?>
                                </select>
                    ...
                    <div class="form-group clearfloat">
                        ...
                        <div class="col-rt lf">
                            <textarea name="intro" id="special"><?php echo ($resume_info["intro"]); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group clearfloat">
                        <div class="col-lf lf">
                        ...
                        <div class="col-rt lf">
                            <input type="text" id="c_tel" name="phone" value="<?php echo ($resume_info["phone"]); ?>"/>
                        </div>
                    </div>
                    <div class="form-group clearfloat">
                        <div class="col-lf lf">
