...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <table class="form_table">
        ...
        <tr class="tr1">
            ...
            <td class="td2"><input class="in_text" type="text" size="35" name="company_name" value="<?php echo ($company_info["company_name"]); ?>" ></td>
            <td class="td3"></td>
        </tr>
        <tr class="tr1">
        ...
        <tr class="tr1">
            <td class="td1">联系人</td>
            <td class="td2"><input class="in_text" type="text" size="35" name="contact" value="<?php echo ($company_info["contact"]); ?>" ></td>
            <td class="td3"></td>
        </tr>
        <tr class="tr1">
            <td class="td1">联系电话</td>
            <td class="td2"><input class="in_text" type="text" size="35" name="tel" value="<?php echo ($company_info["tel"]); ?>" ></td>
            <td class="td3"></td>
        </tr>
        <tr class="tr1">
            ...
            <td>
                <div id="city">
                    <select class="prov" name="province" style="width:auto;">
                        ...
                        <option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $company_info['province']){echo 'selected';} ?>><?php echo ($v["name"]); ?></option>
                        <?php } ?>
                    </select>&nbsp;
        ...
        <tr class="tr1">
            ...
            <td class="td2"><input class="in_text" type="text" size="35" name="address" value="<?php echo ($company_info["address"]); ?>" ></td>
            <td class="td3"></td>
        </tr>
        <tr class="tr1">
            <td class="td1">公司简介</td>
            <td class="td2">
                <textarea name="intro" id="" cols="30" rows="10" style="padding:5px;vertical-align: middle;"><?php echo ($company_info["intro"]); ?></textarea>
            </td>
            <td class="td3"></td>
        </tr>
        <tr class="tr1">
            ...
            <td class="td2">
                <img class="logo_img" src="<?php echo ($company_info["img"]); ?>" style="height:50px;position:relative;top:10px;"/>&nbsp;&nbsp;<input type="file" name="file" class="file" />
            </td>
