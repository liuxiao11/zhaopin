...
<table class="bjw_table">
    ...
    <?php foreach($key_rule_list as $k=>$v){ ?>
    <tr>
        <td><?php echo ($v["id"]); ?></td>
        ...
        <td>
            <a class="a-children" href="/admin/rule/add_rule/rule_id/<?php echo ($v["id"]); ?>" title="添加子节点"></a>
            <a class="a-edit" href="/admin/rule/edit_rule/rid/<?php echo ($v["id"]); ?>" title="修改"></a>
            <a class="a-del" link="/admin/rule/del_rule/rid/<?php echo ($v["id"]); ?>" href="javascript:void(0);" title="删除"></a>
        </td>
    </tr>
    <?php foreach($v['children_two'] as $kk=>$vv){ ?>
    <tr>
        ...
        <td><?php echo ($vv["position"]); ?></td>
        <td>
            <a class="a-children" href="/admin/rule/add_rule/rule_id/<?php echo ($vv["id"]); ?>" title="添加子节点"></a>
            <a class="a-edit" href="/admin/rule/edit_rule/rid/<?php echo ($vv["id"]); ?>" title="修改"></a>
            <a class="a-del" link="/admin/rule/del_rule/rid/<?php echo ($vv["id"]); ?>" href="javascript:void(0);" title="删除"></a>
        </td>
    </tr>
    <?php foreach($vv['children_three'] as $kkk=>$vvv){ ?>
    <tr>
        <td><?php echo ($vvv["id"]); ?></td>
        <td><?php echo ($vvv["level"]); ?></td>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($vvv["title"]); ?></td>
        <td><?php echo ($vvv["name"]); ?></td>
        <td><?php echo ($vvv["position"]); ?></td>
        <td>
            <a class="a-children" href="/admin/rule/add_rule/rule_id/<?php echo ($vvv["id"]); ?>" title="添加子节点"></a>
            <a class="a-edit" href="/admin/rule/edit_rule/rid/<?php echo ($vvv["id"]); ?>" title="修改"></a>
            <a class="a-del" link="/admin/rule/del_rule/rid/<?php echo ($vvv["id"]); ?>" href="javascript:void(0);" title="删除"></a>
        </td>
    </tr>
    <?php foreach($vvv['children_four'] as $k4=>$v4){ ?>
    <tr>
        <td><?php echo ($v4["id"]); ?></td>
        <td><?php echo ($v4["level"]); ?></td>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v4["title"]); ?></td>
        <td><?php echo ($v4["name"]); ?></td>
        <td><?php echo ($v4["position"]); ?></td>
        <td>

            <a class="a-edit" href="/admin/rule/edit_rule/rid/<?php echo ($v4["id"]); ?>" style="margin-left:27px;" title="修改"></a>
            <a class="a-del" link="/admin/rule/del_rule/rid/<?php echo ($v4["id"]); ?>" href="javascript:void(0);" title="删除"></a>
        </td>
    </tr>
    <?php } ?>
    <?php } ?>
