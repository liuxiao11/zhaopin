...
<form action="" method="post">
    ...
    <table class="form_table">
        ...
        <tr class="tr1">
            ...
            <td class="td2"><input class="in_text" type="text" size="35" name="name" value="<?php echo ($person_info["name"]); ?>" ></td>
            <td class="td3">* 必填</td>
        </tr>
        <tr class="tr1">
            <td class="td1">身份证号</td>
            <td class="td2"><input class="in_text" type="text" size="35" name="id_card" value="<?php echo ($person_info["id_card"]); ?>" ></td>
            <td class="td3"></td>
        </tr>
        <tr class="tr1">
            <td class="td1">性别</td>
            ...
            <td>
                <div id="city">
                    <select class="prov" name="province" style="width:auto;">
                        ...
                        <option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $person_info['province']){echo 'selected';} ?>><?php echo ($v["name"]); ?></option>
                        <?php } ?>
                    </select>&nbsp;
                    <select class="city" name="city" style="width:auto;">
                        <option value="0">请选择</option>
                        <?php foreach($city_list as $k=>$v){ ?>
                        <option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $person_info['city']){echo 'selected';} ?>><?php echo ($v["name"]); ?></option>
                        <?php } ?>
                    </select>
                </div>
            </td>
        ...
        <tr class="tr1">
            ...
            <td class="td2">
                <textarea name="intro" id="" cols="30" rows="10" style="padding:5px;vertical-align: middle;"><?php echo ($person_info["intro"]); ?></textarea>
            </td>
            <td class="td3"></td>
        </tr>
        <tr class="tr1">
