...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <table class="form_table">
        <tr class="tr1">
            ...
            <td class="td2"><input class="in_text" type="text" size="35" name="phone" value="<?php echo ($user_info["phone"]); ?>" ></td>
            <td class="td3">* 必填</td>
        </tr>
        <tr class="tr1">
            <td class="td1">昵称</td>
            <td class="td2"><input class="in_text" type="text" size="35" name="nickname" value="<?php echo ($user_info["nickname"]); ?>" ></td>
            <td class="td3">* 必填</td>
        </tr>
        <tr class="tr1">
        ...
        <tr class="tr1">
            ...
            <td class="td2"><input class="in_text" type="text" size="35" name="company_name" value="<?php echo ($headhunt_info["company_name"]); ?>" ></td>
            <td class="td3"></td>
        </tr>
        <tr class="tr1">
            ...
            <td class="td2">
                <select name="company_scale" style="width:150px;">
                    ...
                    <option value="<?php echo ($k); ?>" <?php if($headhunt_info['company_scale'] == $k){echo 'selected';} ?>><?php echo ($v); ?></option>
                    <?php } ?>
                </select>
            </td>
            <td class="td3"></td>
        ...
        <tr class="tr1">
            <td class="td1">联系人</td>
            <td class="td2"><input class="in_text" type="text" size="35" name="contact" value="<?php echo ($headhunt_info["contact"]); ?>" ></td>
            <td class="td3"></td>
        </tr>
        <tr class="tr1">
            <td class="td1">联系电话</td>
            <td class="td2"><input class="in_text" type="text" size="35" name="tel" value="<?php echo ($headhunt_info["tel"]); ?>" ></td>
            <td class="td3"></td>
        </tr>
        <tr class="tr1">
            ...
            <td>
                <div id="city">
                    <select class="prov" name="province" style="width:auto;">
                        ...
                        <option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $headhunt_info['province']){echo 'selected';} ?>><?php echo ($v["name"]); ?></option>
                        <?php } ?>
                    </select>&nbsp;
                    <select class="city" name="city" style="width:auto;">
                        <option value="0">请选择</option>
                        <?php foreach($city_list as $k=>$v){ ?>
                        <option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $headhunt_info['city']){echo 'selected';} ?>><?php echo ($v["name"]); ?></option>
                        <?php } ?>
                    </select>
                </div>
            </td>
        ...
        <tr class="tr1">
            ...
            <td class="td2"><input class="in_text" type="text" size="35" name="address" value="<?php echo ($headhunt_info["address"]); ?>" ></td>
            <td class="td3"></td>
        </tr>
        <tr class="tr1">
            <td class="td1">公司简介</td>
            <td class="td2">
                <textarea name="intro" id="" cols="30" rows="10" style="padding:5px;vertical-align: middle;"><?php echo ($headhunt_info["intro"]); ?></textarea>
            </td>
            <td class="td3"></td>
        </tr>
        <tr class="tr1">
            ...
            <td class="td2">
                <img class="logo_img" src="<?php echo ($headhunt_info["img"]); ?>" style="height:50px;position:relative;top:10px;"/>&nbsp;&nbsp;<input type="file" name="file" class="file" />
            </td>
