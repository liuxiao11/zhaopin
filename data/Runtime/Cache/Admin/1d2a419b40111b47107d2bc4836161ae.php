...
<form action="">
    ...
    <select name="cat" style="width:auto;">
        ...
        <option value="<?php echo ($k); ?>" <?php if($k == $get['cat']){echo 'selected';} ?>><?php echo ($v); ?></option>
        <?php } ?>
    </select>&nbsp;
    <select class="prov" name="work_province" style="width:auto;">
        <option value="0">请选择</option>
        <?php foreach($province_list as $k=>$v){ ?>
        <option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $get['work_province']){echo 'selected';} ?>><?php echo ($v["name"]); ?></option>
        <?php } ?>
    </select>&nbsp;
    <select class="city" name="work_city" style="width:auto;">
        <option value="0">请选择</option>
        <?php foreach($city_list as $k=>$v){ ?>
        <option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $get['work_city']){echo 'selected';} ?>><?php echo ($v["name"]); ?></option>
        <?php } ?>
    </select>
