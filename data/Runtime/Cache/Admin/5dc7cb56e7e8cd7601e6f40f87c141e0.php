...
<form action="" style="float:left;margin-left:40px;position:relative;top:5px;">
    <select name="type" id="">
        ...
        <option value="<?php echo ($k); ?>" <?php if($get['type'] == $k){echo 'selected';} ?>><?php echo ($v); ?></option>
        <?php } ?>
    </select>
...
<table class="bjw_table">
    ...
    <tr>
        ...
        <td><?php echo ($news_type[$v['type']]); ?></td>
        <td><?php echo ($v["title"]); ?></td>
        <td news_id="<?php echo ($v["id"]); ?>">
        ...
        <td><img src="<?php echo ($v["img"]); ?>" style="height:50px;"/></td>
        <td>
            <a class="a-edit" href="/admin/news/edit_news/id/<?php echo ($v["id"]); ?>" title="修改"></a>
            <a class="a-del del_news" news_id="<?php echo ($v["id"]); ?>" href="javascript:void(0);" title="删除"></a>
        </td>
    </tr>
    <?php } ?>
</table>
