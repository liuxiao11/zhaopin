$.fn.sjld = function(shenfen,chengshi,quyu){
	...
	var t1=$('#shenfen>p').text();
	var t2=$('#chengshi>p').text();
	$(sfp).text(t1);
	$(csp).text(t2);
	$(qyp).text(qygsmr[0]);
	//默认城市
...
$('.m_zlxg').click(function(){
	...
	console.log($('#sfdq_tj').val());
	console.log($('#csdq_tj').val());
	})//表单传值获取
...
{name:'上海', cityList:[		   
/*{name:'市辖区', areaList:['黄浦区','卢湾区','徐汇区','长宁区','静安区','普陀区','闸北区','虹口区','杨浦区','闵行区','宝山区',
...
{name:'天津', cityList:[		   
/*{name:'市辖区', areaList:['和平区','河东区','河西区','南开区','河北区','红桥区','塘沽区','汉沽区','大港区','东丽区','西青区',
	'津南区','北辰区','武清区','宝坻区']},
{name:'县', areaList:['宁河县','静海县','蓟州县']},*/
	{name:'请选择', areaList:[]},
	{name:'和平区', areaList:[]},
	{name:'河东区', areaList:[]},
	{name:'河西区', areaList:[]},
...
{name:'重庆', cityList:[		   
/*{name:'市辖区', areaList:['万州区','涪陵区','渝中区','大渡口区','江北区','沙坪坝区','九龙坡区','南岸区','北碚区','万盛区',
	'双桥区','渝北区','巴南区','黔江区','长寿区']},
{name:'县', areaList:['綦江县','潼南县','铜梁县','大足县','荣昌县','璧山县','梁平县','城口县','丰都县','垫江县','武隆县',
