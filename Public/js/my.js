...
$(function(){
  ...
  $('#chose').hover(function(){
    $(this).find('.province-box').fadeIn();
  });
  $('#chose').mouseleave(function(){
    $(this).find('.province-box').fadeOut();
  });
  /*会员中心-侧栏列表*/
  $('.parent-list li>a').click(function(e){
  ...
  /*中心页侧栏二级选择项*/
  var list = $('.parent-list').find('.list');
  var L = $('.parent-list').find('.list').length;
  console.log(L);
  for(var i=0;i<L;i++){
  ...
  /*控制侧栏高度*/
  var H = $('.content-rt').height();
  var h = $('.center-lf').height();
  if(H>h){
    $('.center-lf').height(H);
  }
  console.log(h);
